...
function drawLayerSymbols(painter, sourceCache, layer, coords, isText, translate, translateAnchor,
    ...
    let size;
    const variablePlacement = layer.layout.get('text-variable-anchor');
    const defaultTextSize = layer.layout.get('text-size').property.specification.default;
    ...
    for (const coord of coords) {
        ...
        if (isText) {
            ...
            if (bucket.iconsInText) {
                ...
                const textScaled = size && size.uSize !== defaultTextSize;
                atlasInterpolationIcon = textScaled || transformed || painter.options.rotating || painter.options.zooming ? gl.LINEAR : gl.NEAREST;
            }
        } else {
